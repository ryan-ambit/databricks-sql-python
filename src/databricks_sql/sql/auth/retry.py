...
class DatabricksRetryPolicy(Retry):
    ...
    def should_retry(self, method: str, status_code: int) -> Tuple[bool, str]:
        ...
        if status_code == 404 and self.command_type == CommandType.GET_OPERATION_STATUS:
            return (
                False,
                "GetOperationStatus received 404 code from databricks_sql. Operation was canceled.",
            )
        ...
        if (
            ...
            raise SessionAlreadyClosedError(
                "CloseSession received 404 code from databricks_sql. Session is already closed."
            )
        ...
        if (
            ...
            raise CursorAlreadyClosedError(
                "CloseOperation received 404 code from databricks_sql. Cursor is already closed."
            )
