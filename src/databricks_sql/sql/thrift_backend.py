...
import databricks_sql.sql.auth.thrift_http_client
from databricks_sql.sql.auth.thrift_http_client import CommandType
from databricks_sql.sql.auth.authenticators import AuthProvider
from databricks_sql.sql.thrift_api.TCLIService import TCLIService, ttypes
from databricks_sql.sql import *
from databricks_sql.sql.exc import MaxRetryDurationError
from databricks_sql.sql.thrift_api.TCLIService.TCLIService import (
    Client as TCLIServiceClient,
)

from databricks_sql.sql.utils import (
    ExecuteResponse,
    _bound,
    RequestErrorInfo,
    NoRetryReason,
...
unsafe_logger = logging.getLogger("databricks_sql.sql.unsafe")
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.enable_v3_retries:
            self.retry_policy = databricks_sql.sql.auth.thrift_http_client.DatabricksRetryPolicy(
        ...
        self._transport = databricks_sql.sql.auth.thrift_http_client.THttpClient(
