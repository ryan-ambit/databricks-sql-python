...
from databricks_sql.sql.exc import NotSupportedError
...
class DbsqlParameterBase:
    ...
    from databricks_sql.sql.parameters import DecimalParameter
    param = DecimalParameter(value, scale=None, precision=None)
    cursor.execute("SELECT ?",[param])

    Or

    from databricks_sql.sql.parameters import IntegerParameter
